...
// 能力标注关键字。与 en-US 词法表 "FUNC_PERFORMS": "It performs" 一致
// （Capitalized，与 Module/Rule/If/Let/Return 等句首关键字同约定，也与
// 语料库 87 处 "It performs" 一致）。真正的 bug 曾在词法表把它误写成
// 小写 "it performs"，导致 canonicalizer 输出 "it" 匹配不到 IT 'It'。
IT: 'It';
PERFORMS: 'performs';
